...
// Se admin, mostrar lista de usuários cadastrados
$is_admin = false;
...
// Se já estiver logado e não for admin, redirecionar
...
<head>
    ...
    <title>Cadastro - E-Triagem</title>
                ...
                <form method="POST" class="auth-form">
                    ...
                    <div class="form-group">
                        ...
                        <select id="tipo_sanguineo" name="tipo_sanguineo">
                            ...
                            <?php $tipos_rh_unicos = array(); foreach ($tipos as $t) { $valor = $t['tipo'].$t['rh']; if (!in_array($valor, $tipos_rh_unicos)) { $tipos_rh_unicos[] = $valor; ?>
                                <option value="<?php echo $valor; ?>" <?php if (isset($_POST['tipo_sanguineo']) && $_POST['tipo_sanguineo'] === $valor) echo 'selected'; ?>><?php echo $valor; ?></option>
                            <?php } } ?>
                        </select>
                    </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" id="peso" name="peso" min="0" step="0.1" placeholder="Ex: 70.5">
                    </div>
                    <div class="form-group">
                        <label for="altura">
                        ...
                        <input type="number" id="altura" name="altura" min="0" step="0.01" placeholder="Ex: 1.75">
                    </div>
                    <div class="form-group">
                        <label for="senha">
